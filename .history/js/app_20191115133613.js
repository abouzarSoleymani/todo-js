...
const optionsFA = { month:"short", weekday : "long", day:"numeric"};
const today = new Date();
var localLocale = moment(today);

localLocale.lang('fa');
localLocale.locale('fa');
localLocale.format('D MMMM YYYY');
var formatted = localLocale(today)


dateElementEN.innerHTML = formatted;
